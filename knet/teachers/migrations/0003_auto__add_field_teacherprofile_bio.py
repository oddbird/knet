...
class Migration(SchemaMigration):
    ...
    depends_on = [('accounts', '0003_auto__add_field_user_bio')]

    def forwards(self, orm):
        # Adding field 'TeacherProfile.bio'
        db.add_column('teachers_teacherprofile', 'bio',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TeacherProfile.bio'
        db.delete_column('teachers_teacherprofile', 'bio')
