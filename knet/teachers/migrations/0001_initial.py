...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('teachers_teacherprofile', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(related_name='teacher_profile', unique=True, to=orm['accounts.User'])),
            ('school', self.gf('django.db.models.fields.TextField')(blank=True)),
        ))
        db.send_create_signal('teachers', ['TeacherProfile'])


    def backwards(self, orm):
        # Deleting model 'TeacherProfile'
        db.delete_table('teachers_teacherprofile')
