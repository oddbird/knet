...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for story in orm.Story.objects.all():
            story.submitter = story.profile.user
            story.save()
    ...
    models = {
        ...
        'teachers.story': {
            ...
            'submitter': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['accounts.User']", 'null': 'True', 'related_name': "'submitted_stories'", 'blank': 'True'}),
        ...
        'teachers.teacherprofile': {
            ...
            'user': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['accounts.User']", 'related_name': "'teacher_profile'", 'unique': 'True'})
        }
    }
