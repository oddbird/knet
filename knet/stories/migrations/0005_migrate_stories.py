...
class Migration(DataMigration):
    ...
    depends_on = [('teachers', '0002_auto__add_story')]

    def forwards(self, orm):
        "Write your forwards methods here."
        for story in orm.Story.objects.all():
            orm['teachers.Story'].objects.create(
                **{k:v for k,v in story.__dict__.items() if not k.startswith('_')})

    def backwards(self, orm):
        "Write your backwards methods here."
        for story in orm['teachers.Story'].objects.all():
            orm.Story.objects.create(
                **{k:v for k,v in story.__dict__.items() if not k.startswith('_')})
    ...
    models = {
        ...
        'stories.story': {
            ...
            'profile': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'old_stories'", 'to': "orm['teachers.TeacherProfile']"}),
        ...
        'teachers.teacherprofile': {
            ...
            'user': ('django.db.models.fields.related.OneToOneField', [], {'unique': 'True', 'related_name': "'teacher_profile'", 'to': "orm['accounts.User']"})
        }
    }

    complete_apps = ['teachers', 'stories']
    symmetrical = True
